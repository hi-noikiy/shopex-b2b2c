...
return array(
    ...
    'item' => array(
        ...
        'group' => array(
            ...
            'exportItem'   => ['label' => '导出商品',  'permission' => ['topshop.item.export'] ],
            'importItem'   => ['label' => '导入商品',  'permission' => ['topshop.item.import','topshop.item.export.tmpl', 'topshop.item.import.tmpl'] ],
        ),
    ),
    ...
    'shop' => array(
        ...
        'group' => array(
            ...
            'mobile_decorate' => [
                'label' => '移动端店铺装修',
                'permission' => [
                    'topshop.mobile.decorate.index', 'topshop.mobile.decorate.dialog', 'topshop.mobile.decorate.saveSort',
                    'topshop.mobile.decorate.addTags', 'topshop.mobile.decorate.save', 'topshop.mobile.decorate.ajaxWidgetsDel',
                    'topshop.mobile.decorate.openTags', 'topshop.mobile.decorate.ajaxCheckShowItems', 'topshop.mobile.decorate.checkImageSlider',
                    'topshop.mobile.decorate.searchItem','topshop.mobile.decorate.getBrandList',
                ],
            ],
            'wap_decorate' => [
                'label' => 'H5端店铺装修',
                'permission' => [
                    'topshop.newwap.decorate.edit', 'topshop.newwap.decorate.save', 
                ],
            ],
            'app_decorate' => [
                'label' => 'APP端店铺装修',
                'permission' => [
                    'topshop.app.decorate.edit', 'topshop.app.decorate.save',
                ],
            ],
            'shopapply' => [
                'label' => '入驻信息查看',
    ...
    'shopinfo' => array(
        ...
        'group' => array(
            ...
            'guaranteeMoney' => [
                'label' => '商家保证金详情',
                'permission' => [
                    'topshop.guaranteeMoney.detail','topshop.guaranteeMoney.logdetail','topshop.guaranteeMoney.search',
                ],
            ],
    ...
    'sysstat' => array(
        ...
        'group' => array(
            ...
            'trafficstat' => [
                'label' => '流量数据分析', 'permission' => [ 'topshop.sysstat.systraffic.index', 'topshop.sysstat.stattraffic'],
            ],
        )
    ),
    'account' => array(
