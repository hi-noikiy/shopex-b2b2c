...
return array(
    ...
    */
    ...
    "min"                  => array(
        "numeric" => "数字参数 :attribute 至少是大于 :min 的数值.",
        "file"    => "文件参数 :attribute 至少大于 :min 千字节（KB）.",
        "string"  => "字符串参数 :attribute 至少是 :min 字符.",
    ...
    "Loginaccount" => "参数 :attribute 必须为一个有效的用户名.",
    "tel"          => "参数 :attribute 必须为一个有效的固定电话.",
    "chinese"      => "参数 :attribute 不能用纯数字或中文.",
    "than"         => "参数 :attribute 需大于参数 :other.",
    "bthan"        => "参数 :attribute 需大于等于参数 :other.",
    "sthan"        => "参数 :attribute 需小于等于参数 :other.",
