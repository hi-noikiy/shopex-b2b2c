...
return array(
    '交易设置' => array(
        'trade.cancel.spacing.time' => array( 'type'=>SET_T_INT,'default'=>72,'desc'=>'交易关闭间隔时间','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：小时(h)，自动取消订单</span>'),
        'trade.finish.spacing.time' => array( 'type'=>SET_T_INT,'default'=>7, 'desc'=>'交易完成间隔时间','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：天(d)，自动确认收货</span>'),
    ),
    '积分设置' => array(
    ...
    '基本设置' => array(
        ...
        'user.login.log.clean' => array('type'=>SET_T_INT,'default'=>30,'desc'=>'会员登录日志保留天数','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：天。默认30天</span>'),
        'user.account.register.multipletype' => array('type'=>SET_T_BOOL,'default'=>0,'desc'=>'多账号类型注册','vtype'=>'required','helpinfo'=>'<span class=\'notice-inline\'>【默认只支持手机注册，开启后则支持手机、邮箱、普通用户名三种方式注册】</span>',),
        ...
        'sms.cleanlog.time'=> array( 'type'=>SET_T_INT,'default'=>30,'desc'=>'短信日志保存天数','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：天。默认30天</span>'),
        'shop.cleanloginlog.time'=> array( 'type'=>SET_T_INT,'default'=>30,'desc'=>'商家登录日志保存天数','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：天。默认30天</span>'),
