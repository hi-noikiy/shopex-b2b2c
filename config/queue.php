...
return array(
    ...
    |
    | 默认缓存处理类
    | 目前支持 system_queue_adapter_redis
    | 对应原系统:  QUEUE_SCHEDULE
    |
    */
    'default' => 'system_queue_adapter_redis',
    ...
    */
    'bindings' => array(
        ...
        'sysuser_tasks_pushUserToMatrix' => array('slow'),

        //定向发放红包、优惠券的每条数据执行的队列
        'syspromotion_distribute_tasks_item' => array('quick'),
