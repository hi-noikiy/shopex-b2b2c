    ...
    */
    'listen' => [
        ...
        'user.create' => [
            ...
            ['sysuser_events_listeners_notifyShopexMatrix@createUser', 'async'],
        ],

        //会员修改触发的事件
        'user.basic.update' => [
            //通知矩阵会员信息修改
            ['sysuser_events_listeners_notifyShopexMatrix@updateBasicUser', 'async'],
        ],

        //会员设置用户名触发的事件
        'user.account.setAccount' => [
            //通知矩阵会员信息修改
            ['sysuser_events_listeners_notifyShopexMatrix@setAccount', 'async'],
        ],

        //会员验证邮箱触发的事件
        'user.account.verifyEmail' => [
            //通知矩阵会员信息修改
            ['sysuser_events_listeners_notifyShopexMatrix@verifyEmail', 'async'],
        ],
        ...
        'trade.create' => [
            ...
            // 保存最新的下单发票信息
            ['sysuser_events_listeners_saveInvoice', 'async'],

            //异步
            //创建订单后生成订单日志
            ['systrade_events_listeners_createTradelog@addTradeLog', 'async'],
            ['systrade_events_listeners_createTradelog@addPromotionLog', 'async'],
            //更新活动商品销量
            ['systrade_events_listeners_upActivitySalesCount', 'async'],
            //将订单信息同步到矩阵
            ['systrade_events_listeners_notifyShopexMatrix@tradeCreate', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeCreate', 'async'],
            //消息通知到prism
        ...
        'trade.editPrice' => [
            ...
            ['systrade_events_listeners_notifyShopexMatrix@tradeEditPrice', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeEditPrice', 'async'],
        ],
        ...
        'trade.pay' => [
            ...
            ['systrade_events_listeners_notifyShopexMatrix@tradePay', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradePay', 'async'],
        ],
        ...
        'trade.delivery' => [
            ...
            ['systrade_events_listeners_notifyShopexMatrix@tradeDelivery', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeDelivery', 'async'],
        ],
        ...
        'trade.confirm' => [
            ...
            ['systrade_events_listeners_notifyShopexMatrix@tradeConfirm', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeConfirm', 'async'],
        ],

        //取消订单
        'trade.close' => [
            ['systrade_events_listeners_notifyPrism@tradeClose', 'async', 'queue'=>'system_tasks_notifyPrism'],
            ['systrade_events_listeners_notifyShopexMatrix@tradeClose', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeClose', 'async'],
        ],

        //订单退款
        'trade.refund' => [
            ['systrade_events_listeners_notifyPrism@tradeRefund', 'async', 'queue'=>'system_tasks_notifyPrism'],
            ['systrade_events_listeners_notifyShopexMatrix@tradeRefund', 'async'],
            ['systrade_events_listeners_notifyShopexMatrixByPlatform@tradeRefund', 'async'],
        ],

        'refund.created' => [
            ['sysaftersales_events_listeners_notifyPrism@refundCreated', 'async', 'queue'=>'system_tasks_notifyPrism'],
            ['sysaftersales_events_listeners__notifyShopexMatrix@getRefundInfo', 'async'],
        ],
        ...
        'aftersales.created' => [
            ...
            ['sysaftersales_events_listeners__notifyShopexMatrix@getAftersalesInfo', 'async'],
        ],
        ...
        'aftersales.buyerReturnGoods' => [
            ...
            ['sysaftersales_events_listeners__notifyShopexMatrix@buyerReturnGoods', 'async'],
        ],
        ...
        'category.remove' => [
         ...
         //发送到货通知的邮件
        'item.notify' => [
            ['sysuser_events_listeners_itemNotify@notify', 'async'],
        ],

        //把所有的会员全部同步到matrix（略残忍）
        'platform.matrix.pushAllUser' => [
            ['sysuser_events_listeners_pushAllUserToMatrix@push', 'async'],
        ],
