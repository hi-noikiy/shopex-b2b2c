...
return d.join("\n")},createSubItem:function(a){return a.disabled?"":['<li class="col-md-3">\n<label>',this.createCheckbox(a),a[this.options.label],"</label>\n</li>"].join("\n")},itemSelector:"li",attachEvent:function(){var a=this;this.container.on("click",".thumb",function(){a.toggle(e(this).parent(a.itemSelector))}).on("change",".item > label > input[type=checkbox]",function(b){b=this.checked;e(this).parents(a.itemSelector).eq(0).find(".sub input[type=checkbox]").prop("checked",b);a.setChecked(this,
