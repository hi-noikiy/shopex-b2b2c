    ...
    */
    ...
    Finder = new Class({
        ...
        initView: function() {
            ...
            this.list = $('finder-list-' + this.id);
            this.list && this.list.store('visibility', true);
        ...
        scrollTab: function(tabsWrap,wrap,container){
            ...
            var tabResizeHandle = function(){
                try{
                    ...
                    tabsWrap[w<_w?'addClass':'removeClass']('tabs-scroll').setStyle('width',w);
