...
class topshop_ctl_promotion_package extends topshop_controller {
    ...
    public function save_package()
    {
        ...
        foreach( (array)$params['item_id'] as $key=>$itemId )
        {
            ...
            $itemData['package_price'] = $params['itemList'][$itemId]['package_price'];
            $packageRelItem[] = $itemData;
        }
        $apiData['package_rel_item'] = $packageRelItem ? json_encode($packageRelItem) : null;
        try
        {
