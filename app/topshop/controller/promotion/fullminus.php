...
class topshop_ctl_promotion_fullminus extends topshop_controller {
    ...
    public function save_fullminus()
    {
        ...
        {
            $joinfullminus = array();
            $joinfullminus['full'] = $v;
            $joinfullminus['minus'] = $params['minus'][$k];
        ...
        $fullminusRelItem = null;
        foreach( (array)$params['item_id'] as $key=>$itemId )
        {
            $itemData['item_id'] = $itemId;
            $itemData['sku_id'] = $params['item_sku'][$key];
            $fullminusRelItem[] = $itemData;
        }
        $apiData['fullminus_rel_item'] = $fullminusRelItem ? json_encode($fullminusRelItem) : null;
