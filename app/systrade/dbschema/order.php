...
return  array(
    'columns'=>array(
        ...
        'cat_id' => array(
            ...
            'required' => true,
            'comment' => app::get('systrade')->_('类目id'),
        ),
        'shop_id' => array(
        ...
        'voucher_discount' => array(
            'type' => 'money',
            'default' => '0',
            'comment' => app::get('systrade')->_('购物券优惠分摊'),
        ),
        'voucher_subsidy_proportion' => array(
            'type' => 'money',
            'default' => '0',
            'comment' => app::get('systrade')->_('购物券补贴比例'),
        ),
        'total_fee' => array(
            'type' => 'money',
            'default' => '0',
        ...
        'points_fee' => array(
            'type' => 'money',
            'default' => '0',
            'comment' => app::get('systrade')->_('积分抵扣的金额'),
        ),
