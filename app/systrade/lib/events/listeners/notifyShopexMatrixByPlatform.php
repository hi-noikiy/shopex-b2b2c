 ...
 *
 */
class systrade_events_listeners_notifyShopexMatrixByPlatform implements base_events_interface_queue {
    ...
    private function __notify($tid, $shopId, $objShopexMatrix)
    {
        ...
        $result = $objShopexMatrix->notify('systrade_shopex_tradeCreate', 'platform', $params);
        if( $result['rsp'] == 'fail' )
        {
