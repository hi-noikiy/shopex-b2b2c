...
class sysshop_api_shop_getSubdomain{
    ...
    public function getSubdomain($params)
    {
        ...
        $data['subdomain_limits'] = config::get('app.subdomain_limits');
        $data['subdomain_enabled'] = config::get('app.subdomain_enabled');
        $data['subdomain_basic'] = config::get('app.subdomain_basic');
        return $data;
    }
}
