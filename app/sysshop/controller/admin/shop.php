...
class sysshop_ctl_admin_shop extends desktop_controller{
    ...
    public function saveSelfShop()
    {
        ...
        try
        {
            $res = $objShop->saveShop($postdata, $insertFlag);
    ...
    public function updateCatInfo($shopId,$catId)
    {
        ...
        $catInfo = app::get('sysshop')->rpcCall('category.cat.get',array('cat_id'=>$catId,'fields'=>'cat_id,parent_id,cat_path,level,cat_name,platform_fee,cat_service_rates'));
    ...
    public function saveApply()
    {
        ...
        try{
            ...
            $objMdlShopBrand->update(array('brand_warranty'=>$brandInfo['brand_warranty']),array('brand_id'=>$brandInfo['brand_id'],'shop_id'=>$shop['shop_id']));
