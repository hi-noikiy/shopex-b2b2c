...
return array(
    'columns' => array(
        ...
        'guarantee_money' => array (
            ...
            'in_list' => true,
            'default_in_list' => true,
            'label' => app::get('sysshop')->_('保证金额度'),
            'comment' => app::get('sysshop')->_('保证金额度'),
        ),
        'guarantee_money_warningline' => array(
            'type' => 'number',
            'required' => true,
            'default' => '0',
            'in_list' => true,
            'default_in_list' => false,
            'label' => app::get('sysshop')->_('保证金预警线'),
            'comment' => app::get('sysshop')->_('保证金预警线'),
        ),
    ),
    'primary' => 'shoptype_id',
