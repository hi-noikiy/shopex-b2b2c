    ...
    function main(){
        ...
        if($_POST['col']){
           ...
           $in_use = array_flip($this->getColumnNames());
            ...
            $html .= '<!-----.mainFoot-----<div class="table-action"><button class="btn btn-primary" onclick="$(\''.$domid.'\').fireEvent(\'submit\',{stop:$empty})">'.app::get('desktop')->_('保存提交').'</button></div>-----.mainFoot----->';
