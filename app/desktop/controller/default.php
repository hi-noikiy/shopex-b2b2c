...
class desktop_ctl_default extends desktop_controller{
    ...
    {
        echo base_certi::get_certi_logo_url();exit;
    }
    ...
    function allmenu(){
        ...
        $this->pagedata['shortcuts_menus'] = (array)$shortcuts_menus;
        return view::make('desktop/allmenu.html', $this->pagedata);
    ...
    function main_menu_define(){
        ...
        $this->pagedata['fav_menus'] = (array)$fav_menus;
        $this->pagedata['menus'] = $menus;
        return view::make('desktop/main_menu_define.html', $this->pagedata);
    }
    ...
    function workground(){
        ...
        foreach((array)$sdf as $value){
            ...
            if($value['display']){
                ...
                $url = $value['menu_path'].$params; break;
            }
    ...
    function alertpages()
    {
        ...
        return $this->singlepage('desktop/loadpage.html', $this->pagedata);
    }
    ...
    public function syntax_highlighter(){
        ...
        return view::make('desktop/codemirror.html', $this->pagedata);
    }
}
