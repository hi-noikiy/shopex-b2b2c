...
class topdev_apis {
    ...
    public function getTopApiGroupList($v='v1')
    {
        $apis = $this->getApiList('topapi', $v);
    ...
    public function getSystemParams($isAuth, $type , $v='v1')
    {
        $return = [
            [
                'field' => 'format',
     ...
     */
    public function getApiList($type, $v='v1')
    {
        if( $type == 'topapi' )
        {
            $apis = config::get('topapi.routes.'.$v);
        }
        else
        {
