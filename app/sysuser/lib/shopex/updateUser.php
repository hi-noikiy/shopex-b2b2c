 ...
 */
class sysuser_shopex_updateUser
{

    public $apiMethod = 'store.user.update';

    //网站上的文档有错误，所以这里放了数据结构
    public $userStruct = [
        'uid' => null,              //string 会员在crm上的id 这里和add接口不一样
    ...
    public function handle($params)
    {
        ...
        $postUser = $this->__genUser($userData, $params['crm_user_id']);
    ...
    private function __genUser($userData, $crm_user_id)
    {
        $user = [];
        $user['uid']         = $crm_user_id;
