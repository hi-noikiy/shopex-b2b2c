...
class pam_auth_user
{
	 ...
	 * @return bool
	 */
    protected function setCookie($name, $value, $expire=false, $path=null)
    {
	 ...
	 * @return bool
	 */
    public function login($userId, $loginName = null, $platform= null, $trustLogin=null)
    {
        if (!$loginName)
        {
        ...
        event::fire('user.login', [$userId, $loginName, $platform, $trustLogin]);
