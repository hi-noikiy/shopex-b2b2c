...
return array (
    ...
    array (
        ...
        array(
            ...
            'label' => app::get('sysaftersales')->_('商品ID'),
            'filterdefault' => true,
        ),
        'sku_id'=>
        array(
            ...
            'in_list' => true,
            'default_in_list' => false,
            'label' => app::get('sysaftersales')->_('SKU_ID'),
        ),
        'title' => array(
            //'type' => 'varchar(60)',
            'type' => 'string',
        ...
        'refunds_reason' => array(
            'type' => 'string',
            'length' => 300,
            'comment' => app::get('sysaftersales')->_('商家退款备注'),
        ),
        'sendback_data' =>
        array(
            'type' => 'serialize',
        ...
        'gift_data' => array(
            'type' => 'serialize',
            'default' =>'',
            'comment' => app::get('systrade')->_('赠品数据'),
        ),
    ),
    ...
    'index' => array(
        ...
        'ind_aftersales_type' => ['columns' => ['aftersales_type']],
        'ind_progress' => ['columns' => ['progress']],
