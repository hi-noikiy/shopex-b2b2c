...
class sysaftersales_apply {
    ...
    public function create($data)
    {
        $tradeFiltr = array(
            'tid' => $data['tid'],
            'oid' => $data['oid'],
            'fields' => 'orders.item_id,orders.sku_id,tid,user_id,shop_id,status,orders.oid,orders.user_id,orders.sku_id,orders.num,orders.sendnum,orders.title,orders.gift_data',
        );
        ...
        $saveData['item_id'] = $tradeInfo['orders']['0']['item_id'];
        $saveData['sku_id'] = $tradeInfo['orders']['0']['sku_id'];
