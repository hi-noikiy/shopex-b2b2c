...
class toputil_ctl_themesAjax {
     ...
     * @return json
     */
    public function getChildrenCatList($platform)
    {
     ...
     * @return json
     */
    public function getVirtualCatChildrenList()
    {
        $catId = input::get('cat_id');
        $platform = input::get('platform');
        if($catId)
        {
            $data['data'] = app::get('toputil')->rpcCall('category.virtualcat.get',array('virtual_parent_id'=>$catId,'platform'=>$platform,'fields'=>'virtual_cat_id,virtual_cat_name,child_count'));
        }
        else
        {
            $data=array();
