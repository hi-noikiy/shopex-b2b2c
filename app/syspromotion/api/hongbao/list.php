...
final class syspromotion_api_hongbao_list {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'hongbao_status' => ['type'=>'string',      'valid'=>'in:pending,active,stop',         'title'=>'红包状态',      'description'=>'红包状态 pending active stop'],
            'hongbao_name'   => ['type'=>'string',      'valid'=>'',         'title'=>'红包名称',      'description'=>'红包名称'],
            'platform'       => ['type'=>'string',      'valid'=>'in:pc,wap',         'title'=>'红包适用平台',  'description'=>'红包适用平台 pc wap'],
    ...
    public function get($params)
    {
        ...
        if( in_array($params['platform'], ['pc','wap','app']) )
        {
            $filter['used_platform|in'] = ['all',$params['platform']];
        }
        ...
        {
            $filter['status'] = $params['hongbao_status'];
        }
