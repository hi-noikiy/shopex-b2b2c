...
class syspromotion_api_remind_getData {
    ...
    public function get($params)
    {
        ...
        $params['add_time|bthan'] = $params['bthan'];
        $params['add_time|sthan'] = $params['sthan'];

        if(isset($params['time_field'],$params['bthan'],$params['sthan']) && $params['time_field'] && $params['bthan'] && $params['sthan'])
        {
            $params[$params['time_field'].'|bthan'] = $params['bthan'];
            $params[$params['time_field'].'|sthan'] = $params['sthan'];
            unset($params['time_field'],$params['bthan'],$params['sthan']);
        }
