...
final class syspromotion_api_xydiscount_xydiscountGet {
    ...
    {
        $xydiscountInfo = kernel::single('syspromotion_data_object')->setPromotion('xydiscount')->getPromoitonInfo($params['xydiscount_id']);
        $xydiscountInfo['valid'] = $this->__checkValid($xydiscountInfo);
        if($params['xydiscount_itemList'])
        {
            $xydiscountItems = kernel::single('syspromotion_data_object')->setPromotion('xydiscount')->getPromtionItems($params['xydiscount_id']);
