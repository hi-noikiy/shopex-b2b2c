...
class syspromotion_api_activity_registerList{
    ...
    public function getParams()
    {
        $data['params'] = array(
            ...
            'verify_status'    => ['type'=>'string',        'valid'=>'string',    'title'=>'有效状态',    'example'=>'', 'desc'=>'审核状态'],
    ...
    public function registerList($params)
    {
        ...
        if(isset($params['verify_status']) && $params['activity_status'])
        {
            $filter['verify_status'] = $params['verify_status'];
        }
