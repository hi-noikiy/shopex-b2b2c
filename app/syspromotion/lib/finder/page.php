...
class syspromotion_finder_page {
    ...
    public function column_edit(&$colList, $list)
    {
        ...
        {
                $url = '?app=syspromotion&ctl=admin_page&act=add&_finder[finder_id]='.$_GET['_finder']['finder_id'].'&page_id='.$row['page_id'];
                $target = 'dialog::{title:\''.app::get('syspromotion')->_('编辑专题').'\', width:800, height:530}';
