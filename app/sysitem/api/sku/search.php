...
class sysitem_api_sku_search{
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'sku_id' => ['type'=>'string','valid'=>'','description'=>'商品sku_id，多个id用，隔开','example'=>'2,3,5,6','default'=>''],
            ...
            'page_no' => ['type'=>'int','valid'=>'numeric','description'=>'分页当前页码','example'=>'','default'=>'1'],
            'page_size' =>['type'=>'int','valid'=>'numeric','description'=>'分页每页条数(1<=size<=1000)','example'=>'','default'=>'40'],
    ...
    public function getList($params)
    {
        ...
        $max = 1000000;
        if($pageSize >= 1 && $pageSize <= 1000 && $pageNo >=1 && $pageSize*$pageNo < $max)
        {
            $limit = $pageSize;
            $page = ($pageNo-1)*$limit;
        }
