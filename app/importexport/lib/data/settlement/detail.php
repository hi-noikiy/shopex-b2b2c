...
class importexport_data_settlement_detail{
    ...
    // 商家后台指定的导出字段
    public $shop_export_fields = 'tid,settlement_time,price,pay_time,bn,title,spec_nature_info,num,part_mjz_discount,payment,post_fee,refund_fee,cat_service_rate,commission_fee,settlement_fee,settlement_type,pay_type,refund_type';
