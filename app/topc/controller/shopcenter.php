...
class topc_ctl_shopcenter extends topc_controller
{
    ...
    public function __construct($app)
    {
        ...
        if(config::get('app.subdomain_enabled') && route::currentParameters()['subdomain'])
        {
            // 获取店铺shop_id
            try{
    ...
    public function index()
    {
        ...
        $url = url::action("topwap_ctl_shop@index",array('subdomain'=>$this->subdomain,'shop_id'=>$shopId));
    ...
    public function search()
    {
        ...
        if($params['shop_cat_id']){
            $pagedata['shop_cat_id'] = $params['shop_cat_id'];
        }
