...
class topapi_api_v1_cart_addCart implements topapi_interface_api{
    ...
    {
        return [
            'quantity'        => ['type'=>'int',     'valid'=>'',                             'desc'=>'商品数量',              'example'=>'3',      ],
            'sku_id'          => ['type'=>'int',     'valid'=>'required_if:obj_type,item',    'desc'=>'货品id',                'example'=>'3',      ],
            'package_sku_ids' => ['type'=>'string',  'valid'=>'required_if:obj_type,package', 'desc'=>'组合促销sku_id',        'example'=>'11,21,45'],
            'package_id'      => ['type'=>'integer', 'valid'=>'sometimes|required|integer',   'desc'=>'组合促销id',            'example'=>'3',      ],
            'obj_type'        => ['type'=>'string',  'valid'=>'in:item,package',              'desc'=>'对象类型 item普通商品，package组合促销',  'example'=>'item'],
