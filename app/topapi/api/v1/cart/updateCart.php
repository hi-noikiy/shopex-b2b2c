...
class topapi_api_v1_cart_updateCart implements topapi_interface_api{
    ...
    public function setParams()
    {
        return [
            ...
            'cart_params' => ['type'=>'jsonArray', 'valid'=>'required', 'example'=>'[{"cart_id":1,"is_checked":1,"selected_promotion":13,"totalQuantity":2},{"cart_id":7,"is_checked":1,"selected_promotion":0,"totalQuantity":1}]', 'desc'=>'购物车更新参数', 'params' => [
                //单个购物车项需要的参数
