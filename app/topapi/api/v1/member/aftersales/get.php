...
class topapi_api_v1_member_aftersales_get implements topapi_interface_api {
    ...
    public function setParams()
    {
        //接口传入的参数
        $return = array(
            'aftersales_bn' => ['type'=>'string', 'valid'=>'required_without:oid|numeric', 'example'=>'', 'desc'=>'售后编码'],
            'oid' => ['type'=>'string', 'valid'=>'required_without:aftersales_bn|numeric', 'example'=>'', 'desc'=>'子订单ID'],
    ...
    public function handle($params)
    {
        ...
        else
        {
            ...
            $result = app::get('topapi')->rpcCall('aftersales.get.bn', $params);
        }
