...
class topapi_api_v1_member_updateBasics implements topapi_interface_api{
    ...
    {
        return [
            'username'  => ['type'=>'string', 'valid'=>'required_without_all:name,birthday,sex|max:20',   'example'=>'李四',       'desc'=>'真实姓名',    'msg'=>'此项必填|姓名不能超过20个字'],
            'name'      => ['type'=>'string', 'valid'=>'required_without_all:username,birthday,sex|min:4|max:20',   'example'=>'onexbbc',    'desc'=>'昵称',        'msg'=>'此项必填|昵称最少4个字|昵称不能超过20个字'],
