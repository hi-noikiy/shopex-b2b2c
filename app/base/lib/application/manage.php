...
class base_application_manage
{
    ...
    {
//      //检测config/install.local.php文件是否存在
//       if(!file_exists(CONFIG_DIR.'/install.lock.php'))
//           return false;
//      //检测config/production/database.php文件是否存在
//       if(!file_exists(CONFIG_DIR.'/production/database.php'))
//           return false;
