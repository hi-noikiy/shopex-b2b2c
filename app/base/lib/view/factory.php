...
class base_view_factory
{
    ...
    {
        $object = $this->finder->find($view);
        $this->engine->getCompiler()->clearCache($object);
    }
    ...
    {
        if (!kernel::is_online()) return;
        return app::get('base')->getConf('view_cache_version');
    }
    ...
    {
        return app::get('base')->setConf('view_cache_version', time());
    }
    ...
    {
        $this->events->fire('composing', [$view]);
    }
