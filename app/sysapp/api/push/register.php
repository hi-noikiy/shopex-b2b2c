 ...
 */
final class sysapp_api_push_register{

    /**
     * api接口的名称
     * @var string
     */
    public $apiDescription = 'APP第一次运行时注册的client终端设备';
    ...
    public function reg($params)
    {
        ...
        $ret =  kernel::single('sysapp_push_object')->register($clientid, $token, $type, $plugin);
