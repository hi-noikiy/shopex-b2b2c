 ...
 */
final class ectools_payment_plugin_teegonwxpay extends ectools_payment_app {

    /**
     * @var string 支付方式名称
     */
    public $name = '天工收银（微信支付）';
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '天工收银（微信支付）';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'teegonwxpay';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'teegonwxpay';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '天工收银（微信支付）';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
     ...
     */
    function intro(){
        return '<b><h3>'.app::get('ectools')->_('天工收银是上海商派2015年正式推出的专业集成支付平台，致力于为各类用户提供融合、便捷、安全的场景支付服务。').'</h3></b><bR>'.app::get('ectools')->_('商派天工C2B收银平台，集成主流支付渠道，含微信支付、微信、银联等，业务覆盖B2B、B2C、B2B2C、C2C、O2O等各类场景，协助互联网用户或企业快速开展收银业务，拓展收银场景').'</h3></b>';
    }
    ...
    public function __construct($app)
    {
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_teegonwxpay', 'callback');
...
//        $return['amount'] = 0.01;
    ...
    function callback(&$in){
        ...
        $ret['pay_app_id'] = "teegonwxpay";
        $ret['pay_type'] = 'online';
        $ret['memo'] = 'teegonwxpay';
