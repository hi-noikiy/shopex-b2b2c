...
final class ectools_payment_plugin_99bill extends ectools_payment_app {
	...
	public function dopay($payment){
        ...
        $payment['M_Amount']=bcmul($payment['cur_money'],100,0);
        ...
        $return['payerContact']="";//支付人联系方式
        $return['orderId']= $payment['payment_id'];
        $return['orderAmount'] = $payment['M_Amount'];
        $return['orderTime'] = $orderTime;
        $return['productName'] = $payment['item_title'].'...';
        $return['productNum'] = "1";
        $return['productId'] = "";
        $return['productDesc'] = $payment['item_title'].'等';
        $return['ext1']= "";
        $return['ext2'] = "";
    ...
    function ret_result($paymentId){
        $rtnOk=1;
        $rtnUrl = url::action('topc_ctl_paycenter@finish',array('payment_id'=>$paymentId) );
