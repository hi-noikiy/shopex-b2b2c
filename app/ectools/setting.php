...
//0=>app::get('ectools')->_('无小数位'),1=>app::get('ectools')->_('1位小数'),3=>app::get('ectools')->_('3位小数')
$currency = kernel::single('ectools_data_currency')->getCurrency('all');
$setting = array(
'system.money.decimals'=>array('type'=>SET_T_ENUM,'default'=>2,'desc'=>app::get('ectools')->_('金额精度保留位数'),'options'=>array(2=>app::get('ectools')->_('2位小数'),), ),
//'system.money.decimals'=>array('type'=>SET_T_ENUM,'default'=>2,'desc'=>app::get('ectools')->_('金额精度保留位数'),'options'=>array(2=>app::get('ectools')->_('2位小数'),),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('ectools')->_('注意：如果原来设置成2位小数，现在改成1位小数，可能导致页面显示不正常！如：原来0.01，改成1位小数则变成0.0了。').'</span>'),
