...
return  array(
    'columns'=>array(
        ...
        'alreadytrade'=>array(
            ...
            'length' => 50,
            'default' => 0,
            'label' => app::get('sysstat')->_('已付款订单数'),
            'comment' => app::get('sysstat')->_('已付款订单数'),
            'order' => 3,
        ),
        'alreadyfee'=>array(
            'type' => 'money',
        ...
        'refund_trade'=>array(
            'type' => 'number',
            'default' => 0,
            'label' => app::get('sysstat')->_('退货退款订单数'),
            'comment' => app::get('sysstat')->_('退货退款订单数'),
            'order' => 3,
        ),
        'refund_fee'=>array(
            'type' => 'money',
            'default' => 0,
            'comment' => app::get('sysstat')->_('退货退款订单额'),
        ),
        'reject_trade'=>array(
            'type' => 'number',
            'default' => 0,
            'label' => app::get('sysstat')->_('拒收退款订单数'),
            'comment' => app::get('sysstat')->_('拒收退款订单数'),
            'order' => 3,
        ),
        'reject_fee'=>array(
            'type' => 'money',
            'default' => 0,
            'comment' => app::get('sysstat')->_('拒收退款订单额'),
        ),
        'changing_trade'=>array(
            'type' => 'number',
            'default' => 0,
            'label' => app::get('sysstat')->_('换货订单数'),
            'comment' => app::get('sysstat')->_('换货订单数'),
            'order' => 3,
        ),
        'total_refund_fee'=>array(
            'type' => 'money',
            'default' => 0,
            'comment' => app::get('sysstat')->_('退款总金额'),
        ),
    ...
    'comment' => app::get('sysstat')->_('交易统计表'),
);
