...
class syscategory_ctl_admin_h5virtualcat extends desktop_controller {
    ...
    public function index()
    {
        ...
        $pagedata['tree'] = $tree;
        return $this->page('syscategory/admin/h5virtualcat/map.html', $pagedata);
    }
    ...
    public function add($nCatId = 0)
    {
        ...
        return view::make('syscategory/admin/h5virtualcat/info.html', $pagedata);
    }
    ...
    public function save()
    {
        ...
        if($postData['is_leaf'])
        {
            $this->begin('?app=syscategory&ctl=admin_h5virtualcat&act=leaf&virtual_parent_id='.$postData['virtual_parent_id']);
        }
        else
        {
            $this->begin('?app=syscategory&ctl=admin_h5virtualcat&act=index');
        }
    ...
    public function toRemove()
    {
        ...
        if($_GET['from_finder'])
        {
            $this->begin('?app=syscategory&ctl=admin_h5virtualcat&act=leaf&virtual_parent_id='.input::get('virtual_parent_id'));
        }
        else
        {
            $this->begin('?app=syscategory&ctl=admin_h5virtualcat&act=index');
