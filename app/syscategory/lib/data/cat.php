...
class syscategory_data_cat {
    ...
    {
        set_time_limit(2000);
        $data = app::get('syscategory')->model('cat')->getList('cat_id,parent_id,cat_name,cat_logo,cat_path,level,is_leaf,child_count,order_sort',array(), 0, -1, 'order_sort ASC, cat_id DESC');
